  ...
  <div class="content-wrapper">
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-sm-12 col-xs-12">
          <div class="box box-solid">
            <!-- /.box-header -->
            <div class="box-body">
              <p><img src="img/goldleap.png" style="height: 40px;"><b style="padding-left: 28px; font-size: 16px; font-family: sans-serif;">Welcome to EXA Exchange</b></p>

                
                <p style="font-family: sans-serif; font-size: 15px;">Using the Exacoin Exchange platform, you can exchange EXA to bitcoins directly with no central organization involved. EXA Exchange allows members to buy and sell Exacoin (EXA) directly to and from each other.</p>
     ...
     <div class="container">
        ...
        <div class="col-md-11 col-sm-12 col-xs-12">
          <div class="box box-solid">
            <!-- /.box-header -->
            <div class="box-body">
              <p><img src="img/goldleap.png" style="height: 45px;"><b style="padding-left: 30px; font-size: 15px;">Market Chat</b></p> 
                <img src="img/marketchat.png">
    ...
    <br/>
       ...
       <div class="container">
        <div class="row">
        <div class="col-md-6 col-sm-12 col-xs-12">
                <img src="img/buyexa.png">
          <!-- /.box -->
        </div>

        <div class="col-md-6 col-sm-12 col-xs-12">
                <img src="img/sellexa.png">
          <!-- /.box -->
        </div>
        <!-- ./col -->
      </div>
    ...
    <br/>
        ...
        <div class="row">
        <div class="col-md-6 col-sm-12 col-xs-12">
                <img src="img/buyingorder.png">
          <!-- /.box -->
        </div>

        <div class="col-md-6 col-sm-12 col-xs-12">
                <img src="img/sellingorder.png">
          <!-- /.box -->
        </div>
        <!-- ./col -->
      </div>
    ...
    <div class="container">
        ...
        <div class="col-md-11 col-sm-12 col-xs-12">
          <div class="box box-solid">
            <!-- /.box-header -->
            <div class="box-body">
              <p><img src="img/goldleap.png" style="height: 45px;"><b style="padding-left: 30px; font-size: 15px;">Market History</b></p> 
