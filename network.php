    ...
    <div class="row">
        <div class="col-md-5 col-sm-12 col-xs-12" style="padding-left: 40px;">
          <div class="box box-solid">
            <!-- /.box-header -->
            <div class="box-body">
              <p><img src="img/goldleap.png" style="height: 52px;"><b style="padding-left: 30px; font-size: 17px;">My Team</b></p>
        ...
        <div class="col-md-6 col-sm-12 col-xs-12">
          <div class="box box-solid">
            ...
            <div class="box-body"  style="height: 550px;">
              <p><img src="img/goldleap.png" style="height: 52px;"><b style="padding-left: 30px; font-size: 15px;">Marketing Material</b></p>
