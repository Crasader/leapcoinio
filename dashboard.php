...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="container" style="margin-top: 100px;">
          <div class="row">
            <div class="col-md-5 col-xs-12 col-sm-12">
                   <div data-type="countup" data-id="44532" class="tickcounter" style="width: 100%; position: relative; padding-bottom: 25%"><a href="//www.tickcounter.com/countup/44532/next-ico-will-begin-in" title="NEXT ICO WILL BEGIN IN">NEXT ICO WILL BEGIN IN</a><a href="//www.tickcounter.com/countup" title="Countup">Countup</a></div><script>(function(d, s, id) { var js, pjs = d.getElementsByTagName(s)[0]; if (d.getElementById(id)) return; js = d.createElement(s); js.id = id; js.src = "//www.tickcounter.com/static/js/loader.js"; pjs.parentNode.insertBefore(js, pjs); }(document, "script", "tickcounter-sdk"));</script>
            </div>
    ...
    <section class="content" style="margin-top: 20px;">
      ...
      <div class="row">
        <div class="col-md-3 col-x12 col-sm-12-6">
          <!-- small box -->
          <div class="small-box bg-yellow">
            <div class="inner">
              <p style="font-size: 22px;">USD Balance</p>
        ...
        <div class="col-md-3 col-xs-12 col-sm-12">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <p style="font-size: 22px;">LEC Balance</p>

             
                <h3 style="font-size:35px;">0.00000000<sup style="font-size: 20px"></sup></h3>

            </div>
            <div class="icon">
              <img src="img/goldleap.png">
            </div>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-md-3 col-xs-12 col-sm-12">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <p style="font-size: 22px;">BTC Balance</p>

             
                <h3 style="font-size:30px;">0.00000000<sup style="font-size: 20px"></sup></h3>
       ...
       <div class="col-md-3 col-xs-12 col-sm-12">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <p style="font-size: 22px;">ETH Balance</p>
...
<div>
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <center><h5 style="font-family: sans-serif; color: gray;">ICO</h5></center>
    </div>
  </div>
</div>
      ...
      <div class="row" style="margin-top: 20px;">
        <!-- Left col -->
        <div class="col-md-3 col-sm-12 col-xs-12 connectedSortable" >
            <img src="img/btc2.png" style="width: 100%;" style="margin-top: 20px;">
        ...
        <!-- /.Left col -->
          ...
          <!-- Left col -->
        <div class="col-md-3 col-sm-12 col-xs-12 connectedSortable" style="margin-top: 20px;">
          
                     <img src="img/btc.jpg" style="height: 400px; width: 100%; ">
        ...
        <div class="col-md-3 col-sm-12 col-xs-12 connectedSortable" style="margin-top: 20px;">
                      ...
                      <img src="img/btc3.jpg"  style="height: 350px; width: 100%;">

        </div>

        <div class="col-md-3 col-sm-12 col-xs-12 connectedSortable" style="margin-top: 20px;">

                      <img src="img/btc2.png"  style="height: 350px; width: 100%;">
...
<div>
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <center><h5 style="font-family: sans-serif; color: gray;">WALLET</h5></center>
    </div>
  </div>
</div>
          ...
          <div class="box box-default">
            ...
            <div class="box-body">
              ...
              <p><img src="img/bitcoin.png" style="height: 52px;"><b style="padding-left: 30px; font-size: 18px;">Bitcoin Wallet (BTC)</b></p>
                ...
                <p style="font-size: 16px; font-family:sans-serif;"><b style="font-size: 23px;">Receive Bitcoin (BTC)</b><br/>Get address to accept bitcoin payments</p>
                <hr/>
              <button type="button" class="btn btn-info" data-toggle="modal" data-target="#modal-bitcoin" style=" font-size: 18px; color: white; border-radius:6px; height: 40px; width: 200px;">
                Deposit Bitcoin (BTC)
              </button>
            </div>
          </div>
          ...
          <div class="box box-default">
            ...
            <div class="box-body">
              ...
              <p><img src="img/etherum.png" style="height: 52px;"><b style="padding-left: 30px; font-size: 18px;">Etherum Wallet (ETH)</b></p>
                ...
                <p style="font-size: 16px; font-family:sans-serif;"><b style="font-size: 23px;">Receive Etherum (ETH)</b><br/>Get address to accept etherum payments</p>
                    <hr/>

              <button type="button" class="btn btn-info" data-toggle="modal" data-target="#modal-etherum" style=" font-size: 18px; color: white; border-radius:6px; height: 40px; width: 200px;">
                Deposit Etherum (ETH)
              </button>
            </div>
          </div>
          ...
          <div class="box box-default">
            ...
            <div class="box-body">
              ...
              <p><img src="img/goldleap.png" style="height: 52px;"><b style="padding-left: 30px; font-size: 18px;">Leapcoin Wallet (LEC)</b></p>
                ...
                <p style="font-size: 16px; font-family:sans-serif;"><b style="font-size: 23px;">Receive Leapcoin (LEC)</b><br/>Get address to accept leapcoin payments</p>
             
                   
                    <hr/>
              <button type="button" class="btn btn-info" data-toggle="modal" data-target="#modal-leapcoin" style=" font-size: 18px; color: white; border-radius:6px; height: 40px; width: 200px;">
