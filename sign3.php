  ...
  <aside class="main-sidebar ">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu " data-widget="tree">
             ...
             <li class="nav-item">
                      <a class="nav-link"><b style="font-size: 15px;"><?php if(isset($_SESSION['email'])){
                            echo $_SESSION['email'];
  ...
  <div class="content-wrapper">
    ...
    <div class="container">
      <div class="row" style="margin-top: 30px;">
        <center>
           <div class="col-md-12 col-sm-12 col-xs-12" style="border:1px solid white; height: 230px; background-color: grey;">
